...
export function Projects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: "RKapsilan Research lab website built with Wix Studio",
      longDescription:
        "Website built with Wix Studio and hosted on Wix Studio.",
      image: "/imgs/rk.png", // ✅ correct
      tags: ["Wix Studio"],
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-center text-lime-400 text-2xl mb-6">
